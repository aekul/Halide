...
struct LoopNestFeaturizer : public IRVisitor {
  ...
  struct Jacobian {
    ...
    PipelineFeatures::ScalarType scalar_type;
    PipelineFeatures::AccessType access_type;
  ...
  Jacobian visit_memory_access(Type t, Expr arg, PipelineFeatures::AccessType type);
